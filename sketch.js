...
let dataPie = [2750, 240,435,5456];
let colors = ['purple','blue','yellow','green']
let url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQaBPdPdvg5v8FwrdwYWMRYcmyM_4Tl6FPZht_GOsejAN4X_0znDTi83xfuBd6ArUyQ8MWr4AfvdhDA/pub?output=csv';
let urlAPI = 'https://api.openweathermap.org/data/2.5/weather?q=Lampung&appid=2553833d9ad4b000185b787361a78054&units=metric';
